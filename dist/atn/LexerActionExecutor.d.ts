...
export declare class LexerActionExecutor implements LexerAction {
    #private;
     ...
     */
    static append(lexerActionExecutor: LexerActionExecutor | null, lexerAction: LexerAction): LexerActionExecutor;
    /**
