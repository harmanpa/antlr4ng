...
export declare class PredictionMode {
     ...
     */
    static hasSLLConflictTerminatingPrediction(mode: number, configs: ATNConfigSet): boolean;
    /**
     ...
     * {@link RuleStopState}, otherwise `false`
     */
    static allConfigsInRuleStopStates(configs: ATNConfigSet): boolean;
    /**
     *
     ...
     */
    static resolvesToJustOneViableAlt(altSets: BitSet[]): number;
    /**
     ...
     */
    static allSubsetsConflict(altSets: BitSet[]): boolean;
    /**
     ...
     * {@link BitSet//cardinality cardinality} 1, otherwise `false`
     */
    static hasNonConflictingAltSet(altSets: BitSet[]): boolean;
    /**
     * Determines if any single alternative subset in `altSets` contains
     ...
     * {@link BitSet//cardinality cardinality} > 1, otherwise `false`
     */
    static hasConflictingAltSet(altSets: BitSet[]): boolean;
    /**
     ...
     */
    static allSubsetsEqual(altSets: BitSet[]): boolean;
    /**
     ...
     * @param altSets a collection of alternative subsets
     */
    static getUniqueAlt(altSets: BitSet[]): number;
    /**
     ...
     */
    static getAlts(altSets: BitSet[]): BitSet;
    /**
     ...
     * ```
     */
    static getConflictingAltSubsets(configs: ATNConfigSet): BitSet[];
    /**
     ...
     * ```
     */
    static getStateToAltMap(configs: ATNConfigSet): HashMap<ATNState, BitSet>;
    static hasStateAssociatedWithOneAlt(configs: ATNConfigSet): boolean;
    static getSingleViableAlt(altSets: BitSet[]): number;
}
