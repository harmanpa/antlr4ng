...
export declare class ParseTreeMatch {
     ...
     */
    private readonly mismatchedNode?;
    /**
     ...
     */
    constructor(tree: ParseTree, pattern: ParseTreePattern, labels: MultiMap<string, ParseTree>, mismatchedNode?: ParseTree);
    /**
     ...
     */
    get(label: string): ParseTree | null;
    /**
